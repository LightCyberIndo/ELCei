...
#
################################################################ 
# ---  ./Chu404  ~ Reentz ~ Zx'Phoenix ~ RC_Hunter.        --- #
# --- Pandora ~ Mr.Dongkrak ~./F4LL ~ Mr.Yazz.             --- #
# ---- Mr.Agency ~ Floxytru3 ~ Zona Nolep ~ Mr. Faino      --- #
# --- Gatra ~ IM ./PanjulL21 ~ Mr.s3lf ~ Mr.White.         --- #
# --- w4rnetx ~ Blue Dragon.                               --- # 
# ---   https://palembang-cyber-team.blogspot.com.         --- # 
################################################################ 
#
#
# Based on Web admin locator by CHU404
#
#
#
...
if len(sys.argv) != 2:
	print "\n|---------------------------------------------------|"
        print "| palembangk26[@]gmail[dot]com                      |"
        print "|   04/2k19     Admin login finder v2.0             |"
	print "| Help: python2 admin.py -h                         |"
	print "| Visit https://palembang-cyber-team.blogspot.com   |"
        print "|---------------------------------------------------|\n"
	sys.exit(1)
